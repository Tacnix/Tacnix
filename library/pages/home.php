    ...
    <div class="content p-relative">
      <div class="intro-project">
        <div id="dsn-hero-title" class="intro-title">
          ...
          <p class="mt-20 max-w570 dsn-load-animate">Miena sipu del inora aid consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis nutka, pulvinar dapibus leo della pierrano set amuse.</p>
          <a href="services.html" class="mt-20 dsn-button has-border background-theme image-zoom dsn-load-animate" data-dsn="parallax">Our Services</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="wrapper">
  <!-- ========== Service Section ========== -->
  <section class="services dsn-swiper p-relative section-margin dsn-under-header dsn-load-animate over-hidden" data-dsn-option='{"slidesPerView":2.2,"spaceBetween":15,"centeredSlides":false,"autoplay":true}'>
      <div class="container d-flex text-left flex-column align-items-start">
          <div class="section-title mb-70 ">
              <p class="sub-heading line-shap line-shap-before mb-15"><span class="line-bg-right">OUR SERVICES</span></p>
              <h2 class="section-title">Branding Agency</h2>
          </div>
      </div>
  ...
  <!-- ========== About Section ========== -->
  <section class="about-section-2 p-relative section-margin" data-dsn-title="About Us">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <p class="sub-heading line-bg-left mb-15 text-uppercase">What We Do</p>
        </div>
        <div class="col-lg-6">
          <div class="box-left">
        ...
        <div class="col-lg-6  pr-0">
          <div class="box-im h-100 ">
            <div class="img-container h-100 before-z-index" data-overlay="2" data-dsn-grid="move-up">
              <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/box-gv-img-l.jpg" alt="">
            </div>
          </div>
        </div>
          ...
          <div class="box-info h-100 box-padding background-section ">
            <div class="box-info-inner">
              <div class=" mb-50 d-flex text-left flex-column align-items-start">
                <h2 class="section-title">We combine design and thinking and technical craft.</h2>
                <p class="sub-heading line-shap line-shap-after mt-15"><span class="line-bg-left text-uppercase">Some Feature</span></p>
              </div>
              <p class="max-w570 dsn-up mb-10 ">When our team provides design and digital marketing. Applied arts can include industrial design, graphic design,</p>
              <p class="max-w570 dsn-up"> fashion design, and the decorative arts which traditionally includes craft objects.</p>
              <div class="border-bottom mt-30 mb-30"></div>
              <ul class="pb-30 border-bottom">
                <li class="lest-number mb-15"><span class="number">1</span> <span class="sm-title-block">Next level Business consulting services</span></li>
              ...
              <a href="services.html" class="mt-30 dsn-button has-border background-theme image-zoom" data-dsn="parallax">View More<span class="icon">⟶</span></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row dsn-z-index-2">
        <div class="col-lg-6 pr-0  box-content">
          <div class="box-info h-100 box-padding background-section ">
            <div class="box-info-inner">
              <div class="mb-50 d-flex text-left flex-column align-items-start">
                <h2 class="section-title">Financing solutions</h2>
                <p class="sub-heading line-shap line-shap-after mt-15">
                  <span class="line-bg-left text-uppercase">Some Feature</span>
                </p>
              </div>
              <p class="max-w570 dsn-up">A business consulting agency is involved in the planning, implementation, and education of businesses. We work directly with business owners on developing a business plan, identifying marketing needs and developing the necessary skills for business ownership.</p>
              <div class="border-bottom mt-30 mb-30"></div>
        ...
        <div class="col-lg-6   pl-0">
          <div class="box-im h-100 ">
            <div class="img-container h-100 before-z-index" data-overlay="4" data-dsn-grid="move-up">
              <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/box-gv-img-r.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- ========== Skill Section ========== -->
  <section class="skills-personal p-relative section-margin" data-dsn-animate="section">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="box-img box-img-tow-col d-flex h-100">
            <div class="img-item pr-15 w-50 mb-80 ">
              <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/visual-strategies-left.jpg" alt="">
            </div>
            <div class="img-item w-50 pl-15 mt-80">
              <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/visual-strategies-right.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="box-skills-inner">
            <div class="mb-50 d-flex text-left flex-column align-items-start">
              <h2 class="section-title">We help to create visual strategies.</h2>
              <p class="sub-heading line-shap line-shap-after mt-15"><span class="line-bg-left text-uppercase">CAPABILITIES</span></p>
            </div>
            <p class="mb-30">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed obcaecati autem distinctio veritatis excepturi, fugit iste repellendus, porro delectus rem ducimus cum fugiat, magnam voluptates cumque? Consequatur eos debitis sit?</p>
            <div class="skills-item mb-30">
              <h4 class="sm-title-block mb-15">Web Design</h4>
              <div class="bar">
                <span class="fill background-theme" data-width="85%">
            ...
            <div class="skills-item  mb-30">
              <h4 class="sm-title-block mb-15">SEO, analytics & marketing</h4>
              <div class="bar">
                <span class="fill background-theme" data-width="72%">
            ...
            <div class="skills-item">
              <h4 class="sm-title-block mb-15">Mobile Development</h4>
              <div class="bar">
                <span class="fill background-theme" data-width="89%">
  ...
  <!-- ========== facts-section ========== -->
  <div class="facts-section p-relative section-padding background-section section-margin over-hidden">
      ...
      <div class="d-grid grid-lg-4 grid-sm-2">
        ...
        <div class="facts-item">
          <div class="text-center p-relative">
            ...
            <h6 class="sm-title-block v-middle w-100">Finished Tearly Project</h6>
          </div>
        </div>
      </div>
    </div>
  ...
  ?>
  <!-- ========== blog Section ========== -->
  <section class="our-blog our-blog-classic not-filter section-margin p-relative dsn-swiper" data-dsn-animate="section" data-dsn-option='{"slidesPerView":3,"spaceBetween":30 }' data-dsn-title="None">
    <div class="container mb-70 d-flex text-left flex-column align-items-start">
      ...
      <p class="sub-heading line-shap line-shap-after mt-15"><span class="line-bg-left text-uppercase">Our News</span></p>
    </div>
    <div class="container">
      <div class="swiper-container ">
        <div class="swiper-wrapper">
            ...
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100">
              <div class="box-meta">
                <div class="entry-date">
                  <span class="author">Tacnix</span>
                  <a href="#">March , 17th 2020</a>
                </div>
              </div>
              <div class="box-img over-hidden">
                <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/blog/1.jpg" alt="">
              </div>
            ...
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100">
              ...
              <div class="box-content p-relative">
                <div class="box-content-body">
                  ...
                  <h4 class="title-block"><a href="#">The Day I Lost My Child in Charles de GaulleAirport</a></h4>
                  <a href="#" class="link-vist p-relative mt-20">
                    <span class="link-vist-text">Load More</span>
                    <div class="link-vist-arrow">
                      <svg viewBox="0 0 80 80">
            ...
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100">
              ...
              <div class="box-content p-relative">
                <div class="box-content-body">
                  ...
                  <h4 class="title-block"><a href="#">Relationships Aren’t Easy, But They’re Worth It</a></h4>
                  <a href="#" class="link-vist p-relative mt-20">
                    <span class="link-vist-text">Load More</span>
                    <div class="link-vist-arrow">
                      <svg viewBox="0 0 80 80">
...
<section class="testimonials testimonials-personal section-margin" data-dsn-title="testimonials">
  <div class="container mb-70 d-flex text-left flex-column align-items-start">
    ...
    <p class="sub-heading line-shap line-shap-after mt-15"><span class="line-bg-left text-uppercase">Feedback</span></p>
  </div>

  <div class="container">
    <div class="testimonials-box box-padding p-relative w-100 background-section">
      <div class="testimonials-inner p-relative w-100 dsn-swiper" data-dsn-controller=".testimonial-content" data-dsn-option='{"slidesPerView":3,"spaceBetween":50 }'>
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    ...
                    <div class="box-text" data-swiper-parallax="30%" data-swiper-parallax-opacity="0">
        ...
        <div class="testimonial-content text-center">
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <p class="p-larg" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">"The designer is just amazing! Very good quality and taste. This template is incredible beautiful. The overall impression is more than good.The support cannot be better. I wish the team all success!"</p>
              </div>

              <div class="swiper-slide">
                <p class="p-larg" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">"First of all, I really enjoyed setting this up. What a great layout and design. The support is fast and high quality. They really made an effort to make sure I got the help I needed. keep in mind that it is not only a great design, but also it is easy to change it up with little effort. Great Job!"</p>
              </div>

              <div class="swiper-slide">
                <p class="p-larg" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">"This theme is awesome and the designer is very helpful. I had a few questions before purchase. He/She helped me with all the doubts. Also, they provide quick support. Thank you so much for a beautiful theme"</p>
              </div>

              <div class="swiper-slide">
                <p class="p-larg" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">"Basically im using this theme as a base for my new website and i couldnt be happier. Ran into some bumps but the team who developed this theme was there to help me with any problems. Very slick nice ajax portfolio theme"</p>
              </div>
            </div>
              ...
              <div class="swiper-next">
                <div class="next-container">
                  <div class="container-inner">
                    <div class="triangle"></div>
                    <svg class="circle" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g class="circle-wrap" fill="none" stroke-width="1" stroke-linejoin="round" stroke-miterlimit="10"><circle cx="12" cy="12" r="10.5"></circle></g>
                    </svg>
                  </div>
                </div>
              </div>
