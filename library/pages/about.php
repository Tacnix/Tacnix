...
<div class="wrapper">
    <div class="image-head p-relative">
        <div class="before-z-index" data-dsn-grid="move-up" data-overlay="5">
            <img class="cover-bg-img has-bigger-scale" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/about/5.jpg" alt="">
        </div>
    </div>
    ...
    <section class="about-section-2 p-relative section-margin" data-dsn-title="About">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="sub-heading line-shap line-shap-before mb-15"><span class="line-bg-right">What We Do</span></p>
                </div>
                <div class="col-lg-6">
                    <div class="box-left">
                ...
                <div class="col-lg-6">
                    <div class="box-right">
                        <p class="max-w570 dsn-up mb-15 ">Tacnix is a founded in 2011 in house doing a website project for first client. Leter on worked on multiple website designing projects. Then we include a Domain Registration &amp; Web Hosting services into our list of services in 2015. Tacnix established in the year of 2011 with a vision to provide Internet Solutions with comprehensive range of web services like Web Designing, Domain Name Registration, Web Hosting, E-Mail Solutions & SSL Certificates, &amp; more. We gained recognition with high quality projects on the local Indian market and as well as outside of India too.</p>
    ...
    <div class="section-margin has-popup over-hidden p-relative">
        <div class="container">
            <div class="d-grid grid-md-2  over-hidden">
                <a href="<?=img?>/help-project.jpg" class="p-relative over-hidden d-flex h-v-60"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/help-project.jpg" data-dsn-srcset="<?=img?>/help-project.jpg 1800w,<?=img?>/help-project-sm.jpg 768w" alt="" class="cover-bg-img"> </a>
                <a href="<?=img?>/plan-project.jpg" class="p-relative over-hidden d-flex h-v-60"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" ata-dsn-src="<?=img?>/plan-project-sm.jpg" data-dsn-srcset="<?=img?>/plan-project.jpg 1800w,<?=img?>/plan-project-sm.jpg 768w" alt="" class="cover-bg-img"></a>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="box-left">
                        <div class="container mb-30 d-flex flex-column align-items-start">
                            <p class="sub-heading line-shap line-shap-before mb-15"><span class="line-bg-right">Awards & Honors</span></p>
                            <h2 class="section-title">The awards won<br> by our project.</h2>
                        </div>
                        <div class="awards-inner mt-30">
                            <div class="award-item">
                                <div class="award-number">4</div>
                                <div class="award-logo"><img src="<?=img?>/awwwards.png" alt=""></div>
                                <h4 class="sm-title-block">WEBSITE OF THE DAY</h4>
                            </div>
                            <div class="award-item">
                                <div class="award-number">6</div>
                                <div class="award-logo"><img src="<?=img?>/cssdesignawards.png" alt=""></div>
    ...
    <section class="team team-about section-margin p-relative" data-dsn-title="Team">
        <div class="container mb-70 d-flex flex-column">
            <p class="sub-heading line-shap line-shap-before mb-15"><span class="line-bg-right"> our team</span></p>
            ...
            <div class="d-grid grid-lg-2 grid-sm-2">
                ...
                <div class="team-item dsn-up">
                    <div class="team-item-inner">
                        <div class="team-item-wapper background-section">
                            <div class="item-content d-flex a-item-center">
                                <div class="box-img"><img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/team/3.jpg" alt=""></div>
                                <div class="box-text">
    ...
    <section class="testimonials testimonials-personal section-margin" data-dsn-title="testimonials">
        <div class="container mb-70 d-flex flex-column">
            <p class="sub-heading line-shap line-shap-before mb-15"><span class="line-bg-right">Feedback</span></p>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="box-img mb-15" data-swiper-parallax-scale="0.7"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/team/1.jpg" alt=""></div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-img mb-15" data-swiper-parallax-scale="0.7"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/team/2.jpg" alt=""></div>
                                        <div class="box-text" data-swiper-parallax="30%" data-swiper-parallax-opacity="0">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-img mb-15" data-swiper-parallax-scale="0.7"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/team/3.jpg" alt=""></div>
    ...
    <section class="brand-client section-margin" data-dsn-animate="section" data-dsn-title="Client">
        <div class="container mb-70 d-flex flex-column">
            <p class="sub-heading line-shap line-shap-before mb-15"><span class="line-bg-right"> Our clients</span></p>
        ...
        <div class="container">
            <div class="wrapper-client">
                ...
                <div class="logo-box dsn-up">
                    <div class="logo-box-inner">
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/logo/5.png" alt="">
                    </div>
                </div>

                <div class="logo-box dsn-up">
                    <div class="logo-box-inner">
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/logo/6.png" alt="">
                    </div>
                </div>
