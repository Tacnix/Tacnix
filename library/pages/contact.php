<header class="header-page over-hidden p-relative header-padding-top header-padding-bottom dsn-header-animation">
  ...
  <div class="dsn-container">
    <div class="content-hero p-relative d-flex align-items-center text-center flex-column h-100 dsn-hero-parallax-title">
      <p class="subtitle p-relative line-shap  "><span class="pl-10 pr-10 background-section dsn-load-animate">Lat's Tock</span></p>
...
<div class="wrapper">
  <div class="container root-contact">
    <div class="full-width">
      <div class="map-custom p-absolute w-100 h-100" data-dsn-lat="20.605879407973028" data-dsn-len="72.91638754213008" data-dsn-zoom="14"></div>
    </div>
          ...
          <div class="box-info-contact">
            <ul>
              <li>
                ...
                <div class="over-hidden mt-5"><a class="link-hover" data-hover-text="<?=contact_email?>" href="mailto:hello@tacnix.com?subject=Website Contact Form&body=Hello, I would like to know further about your services."><?=contact_email?></a></div>
              </li>
              <li>
              ...
              <li>
                ...
                <div class="social-item over-hidden"><a class="link-hover" data-hover-text="Twitter." href="<?=twitter?>" target="_blank" rel="nofollow">Twitter</a></div>
                <div class="social-item over-hidden"><a class="link-hover" data-hover-text="Instagram." href="<?=instagram?>" target="_blank" rel="nofollow">Instagram</a></div>
                <div class="social-item over-hidden"><a class="link-hover" data-hover-text="Facebook." href="<?=facebook?>" target="_blank" rel="nofollow">Facebook</a></div>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="container">
      <div class="c-wapp d-flex justify-content-between">
        ...
        <div class="button-box d-flex justify-content-end align-items-center">
          <div><a href="?page=work&from=contact" class="mt-30 effect-ajax dsn-button p-relative"><span class="dsn-border-rdu "></span>Owr Work</a></div>
        </div>
      </div>
    </div>
  </section>
