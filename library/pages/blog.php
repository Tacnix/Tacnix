            ...
            <div class="dsn-posts d-grid grid-lg-1">
                <div class=" blog-item p-relative d-flex align-items-center h-100 w-100"
                    ...
                    <div class="box-content p-relative">
                        <div class="box-content-body">
                            <div class="metas"><span class="mb-5">Lifestyle</span></div>
                            <h4 class="title-block mb-20 "><a href="post.html" class="effect-ajax">The Day I Lost My Child in Charles de Gaulle Airport</a></h4>
                            <p>Whoever said “It’s not about the destination. It’s the journey” never flew on a long ...</p>
                            <a href="?p=blog&get=post&id=<?=$fid;?>" class="effect-ajax link-vist p-relative mt-20">
                ...
                <div class=" blog-item p-relative d-flex align-items-center h-100 w-100"
                    ...
                    <div class="box-img over-hidden">
                        <img class="cover-bg-img"
                            ...
                            data-dsn-src="<?=img?>/blog/2.jpg" alt="">
                    </div>
                    <div class="box-content p-relative">
                        ...
                        <div class="box-content-body">
                            ...
                            <h4 class="title-block mb-20 ">
                                <a href="post.html" class="effect-ajax">Extreme Athleticism Is the New Midlife Crisis</a>
                            </h4>
                            <p>Whoever said “It’s not about the destination. It’s the journey”
                                never
                                flew on a long ...</p>
                            <a href="post.html" class="effect-ajax link-vist p-relative mt-20">
                ...
                <div class=" blog-item p-relative d-flex align-items-center h-100 w-100"
                    ...
                    <div class="box-img over-hidden">
                        <img class="cover-bg-img"
                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                            data-dsn-src="<?=img?>/blog/3.jpg" alt="">
                    </div>
                    <div class="box-content p-relative">
                ...
                <div class=" blog-item p-relative d-flex align-items-center h-100 w-100"
                    ...
                    <div class="box-img over-hidden">
                        <img class="cover-bg-img"
                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                            data-dsn-src="<?=img?>/blog/1.jpg" alt="">
                    </div>
                    <div class="box-content p-relative">
