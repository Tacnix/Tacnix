  ...
  <div class="facts-section p-relative   section-margin over-hidden">
                        ...
                        <div class="box-info-inner">
                          ...
                          <div class="d-flex border-top pt-30 mb-30">
                            ...
                            <ul class="w-50 pl-10">
                              ...
                              <li class="lest-number d-flex"><i class="fas fa-check-circle theme-color mr-15"></i><span class="sm-title-block">SEO / SEM / PPC</span></li>
                            </ul>
                          </div>
        ...
        <div class="container">
            <div class="row dsn-z-index-2">
                ...
                <div class="col-lg-6  dsn-z-index-2 pl-0">
                    <div class="box-im h-100 ">
                        <div class="img-container h-100" data-dsn-grid="move-up">
                          <img class="cover-bg-img " data-dsn-speed="4" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/help-project.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row dsn-z-index-2">
                ...
                <div class="col-lg-6  dsn-z-index-2 pl-0">
                    <div class="box-im h-100 ">
                        <div class="img-container h-100" data-dsn-grid="move-up">
                          <img class="cover-bg-img " data-dsn-speed="4" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/corprate.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="d-grid grid-lg-3 grid-sm-2">
                    ...
                    <div class="service-lest-item p-relative">
                        ...
                        <div class="content ml-0">
                            <h4 class="title-block mb-15">Best selling author</h4>
                            <p>We’ve designed a culture that allows our stewards to assimilate with our clients and bring.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="team tam-classic section-margin p-relative " data-dsn-animate="section">
        <div class="container mb-70 d-flex text-left flex-column align-items-start">
            <p class="sub-heading line-shap line-shap-after mb-15"><span class="line-bg-left"> our team</span></p>
            <h2 class="section-title  title-cap">The best team ever!</h2>
        </div>
