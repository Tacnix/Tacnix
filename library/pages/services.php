                            ...
                            <div class="d-flex border-top pt-30 mb-30">
                                <ul class="w-50 pr-10">
                                    <li class="lest-number mb-15 d-flex">
                                        <i class="fas fa-check-circle theme-color mr-15"></i>
                                        <span class="sm-title-block">Proin gravida nibh vel</span>
                                    </li>

                                    <li class="lest-number d-flex">
                                        <i class="fas fa-check-circle theme-color mr-15"></i>
                                        <span class="sm-title-block">Auctor aliquet aenean quis</span>
                                    </li>
                                </ul>
