  ...
  <div class="main-slider full-width has-horizontal p-relative w-100 h-100-v dsn-header-animation">
    <div class="content-slider p-relative w-100 h-100 over-hidden v-dark-head">
        ...
        <div class="slide-inner h-100">
          <div class="swiper-wrapper">
            <div class="slide-item swiper-slide over-hidden">
              <div class="image-bg cover-bg w-100 h-100 " data-overlay="6" data-swiper-parallax="85%" data-swiper-parallax-scale="1.1">
                <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/header2.jpg" alt="">
              </div>
              <div class="slide-content p-absolute ">
                <div class="content p-relative">
                  <p class="max-w570 mb-15 description">We are a design & development agency</p>
            ...
            <div class="slide-item swiper-slide over-hidden">
              <div class="image-bg cover-bg w-100 h-100 " data-overlay="6"
                  ...
                  <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/header4.jpg" alt="">
              </div>
              <div class="slide-content p-absolute  ">
                <div class="content p-relative">
                  <p class="max-w570 mb-15 description">we combine design, thinking and technical craft</p>
                  <div class="d-block"></div>
            ...
            <div class="slide-item swiper-slide over-hidden">
              <div class="image-bg cover-bg w-100 h-100 " data-overlay="6" data-swiper-parallax="85%" data-swiper-parallax-scale="1.1">
                <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/header_9.jpg" alt="">
              </div>
              <div class="slide-content p-absolute  ">
                <div class="content p-relative">
                  <p class="max-w570 mb-15 description">We're a design studio that believe in the ideas</p>
                  <div class="d-block"></div>
      ...
      <div class="dsn-slider-content p-absolute h-100 w-100 ">
        <div class="dsn-container  d-flex align-items-center justify-content-center text-center"></div>
      </div>
    </div>
...
<div class="wrapper">
          ...
          <div class="col-lg-6">
            <div class="box-img box-img-tow-col d-flex h-100">
              <div class="img-item pr-15 w-50 mb-80 ">
                <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/about_intro_2.jpg" alt="">
              </div>
              <div class="img-item w-50 pl-15 mt-80">
                <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="<?=img?>/about_intro_1.jpg" alt="">
              </div>
              </div>
          </div>
          <div class="col-lg-6">
            <div class="box-info ">
              <div class="mb-30">
                <p class="sub-heading line-shap line-shap-after mb-15"><span class="line-bg-right">ABOUT DIGITAL AGENCY</span></p>
    ...
    <!-- ========== Service Section ========== -->
    <section class="services with-line dsn-swiper p-relative section-margin" data-dsn-title="our Services" data-dsn-option='{"slidesPerView":3,"spaceBetween":0}'>
      <div class="container mb-70 d-flex text-center flex-column align-items-center">
        <p class="sub-heading line-shap line-shap-after mb-15"><span class="line-bg-left">WHY CHOOSE US?</span></p>
              ...
              <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    ...
                    <div class="services-content  background-section ">
                      ...
                      <div class="service-description">
                        <h4 class="title-block mb-15">Domain &amp; Web Hosting</h4>
                        <p>We develop the relationships that underpin the next phase in your organisation’s growth. We do this by discerning the people.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="swiper-slide">
                  <div class="services-item-inner" data-swiper-parallax-scale="0.85">
                    ...
                    <div class="services-content  background-section ">
                      ...
                      <div class="service-description">
                        <h4 class="title-block mb-15">Website Maintenance</h4>
                ...
                <div class="swiper-slide">
                  <div class="services-item-inner" data-swiper-parallax-scale="0.85">
                    ...
                    <div class="services-content  background-section ">
                      ...
                      <div class="service-description">
                        <h4 class="title-block mb-15">Digital Marketing</h4>
                        <p>For 10+ years now, we’ve mastered the top web technologies to deliver projects that have raked in investments.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="swiper-slide">
                  <div class="services-item-inner" data-swiper-parallax-scale="0.85">
                    ...
                    <div class="services-content  background-section ">
                      ...
                      <div class="service-description">
                        <h4 class="title-block mb-15">Graphic Designing</h4>
    ...
    <?php if (work >= 1 ) { ?>
    <section class="work-section work-no-scale not-filter p-relative dsn-swiper over-hidden v-light-head" data-dsn-title="our Work" data-dsn-option='{"slidesPerView":3,"autoplay":true,"centeredSlides":false}'>
      <div class="container mb-70 d-flex text-center flex-column align-items-center">
        <p class="sub-heading line-shap line-shap-after mb-15"><span class="line-bg-left">Our Work</span></p>
        <h2 class="section-title">We are delivering beautiful <br> digital products for you.</h2>
      </div>
      <div class="swiper-container" data-swiper-autoplay="5000">
          <div class="swiper-wrapper">
            <?php if (file_exists(pages . ds . 'projectslid.php')) { include(pages . ds . 'projectslid.php'); } ?>
          </div>
      </div>
    </section>
    <?php } ?>
    ...
    <section class="our-blog  our-blog-classic not-filter section-margin p-relative dsn-swiper"
        ...
        <div class="container mb-70 d-flex text-center flex-column align-items-center">
            <p class="sub-heading line-shap line-shap-after mb-15"><span class="line-bg-left">OUR NEWS</span></p>
                        ...
                        <div class=" blog-item p-relative d-flex align-items-center h-100 w-100">
                            ...
                            <div class="box-content p-relative">
                                <div class="box-content-body">
                                    <div class="metas"><span>Lifestyle</span></div>
                                    <h4 class="title-block"><a href="#">Extreme Athleticism Is the New</a></h4>
                                    <a href="#" class="link-vist p-relative mt-20"><span class="link-vist-text">Load More</span>
